...
(function() {
  ...
  $.fn.updateChosen = function(objeto) {
    return objeto.trigger("chosen:updated");
  };
...
(function() {
  ...
  ready = function() {
    return $(':input[type=date]').focusout(function() {
      var date, dd, mm, yyyy;
      date = $(this).val().split('-');
      dd = parseInt(date[2]);
      mm = parseInt(date[1]);
...
(function() {
  ...
  ready = function() {
    ...
    jQuery.fn.activarCalcular = function() {
      return $('input:text').focusout(function() {
        var rta;
    ...
    jQuery.fn.calcular = function(texto) {
      var fx, rta;
      if (texto[0] === "=") {
        try {
    ...
    return jQuery.fn.activarCalcular();
  };
